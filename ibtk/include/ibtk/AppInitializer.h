 ...
 * databases placed beside component configuration. They accept scalar Boolean,
 * integer, floating-point, and string values; a tagged key `k` produces
 * `-<tag>_<k>`. Alternatively, the top-level `PETSC_OPTIONS_FILE` or
 * `petsc_options_file` key selects an input-relative options file. Command-line
